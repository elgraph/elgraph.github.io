...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__Mashine.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function prepareExternalInterface(app) {
    ...
    app.ExternalInterface.loadContent = function(myObject) {
		parent.load_content(myObject);
		//parent.load_alert(myObject);
    }
    app.ExternalInterface.loadAlert = function(txt) {
		//alert(txt);
		parent.load_content(txt);
		//parent.load_alert(myObject);
    }
